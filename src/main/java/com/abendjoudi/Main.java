...
class TodoAPIWrapper {
    ...
    public Todo getTodo(int id) {
        ...
        try {
            ...
            System.out.println("Unable to get task with id" + id);
        }
        return null;
    }
    ...
    public boolean removeTodo(int id) {
        ...
        try {
            ...
            System.out.println("Unable to delete task with ID " + id);
        }
        return false;
    }
    ...
    public Todo getTasksWithPriority(int priority){
        TodoCollection tasks = getTodos();
        for (Todo task: tasks) {
...
public class Main {
    public static void main(String[] args) {
        ...
        todoAPI.createTodo("play", "Play PS4", 1);
        todoAPI.createTodo("Laundry", "Wash Laundry", 4);
        ...
        //update existing
        System.out.println("------------------------");
        System.out.println("-Updating existing task-");
        System.out.println("------------------------");
        Todo aTodo = todoAPI.getTodo(6);
        aTodo.setTitle("Workout");
        aTodo.setBody("Go to the gym");
        boolean updateSuccess = todoAPI.updateTodo(aTodo);
        System.out.println("Update success: " + updateSuccess );

        aTodo = todoAPI.getTodo(4);
        aTodo.setTitle("pay bills");
        aTodo.setBody("Pay Gas Bill");
        aTodo.setPriority(5);

        updateSuccess = todoAPI.updateTodo(aTodo);
        System.out.println("Update success: " + updateSuccess );

        System.out.println("-----------------------");
        System.out.println("-Getting updated tasks-");
        System.out.println("-----------------------");
        todos = todoAPI.getTodos();
        for (Todo task: todos) {
            System.out.println(task);
        ...
        int priority=2;
        System.out.println("---------------------------------");
        System.out.println("-Getting tasks with priority : "+ priority +"-");
        System.out.println("---------------------------------");
        todoAPI.getTasksWithPriority(priority);
    }
}
